    ...
    <div class="modal-content modal-formulario" @click.stop>
     ...
     <div class="modal-footer">
       ...
       <button 
         ...
         :disabled="guardandoServicio || formulario.categoriasSeleccionadas.length === 0"
       >
...
return {
  ...
  estadisticas: {
    ...
    inactivos: 0,
    precio_promedio: 0,
    servicios_con_multiples_categorias: 0 // 🆕 NUEVO
  },

  // 🔧 ACTUALIZADO: Filtros con múltiples categorías
  filtros: {
    busqueda: '',
    categoriasSeleccionadas: [], // 🆕 NUEVO
    rangoPrecio: '',
    estado: ''
  },

  // 🔧 ACTUALIZADO: Formulario con múltiples categorías
  formulario: {
    nombre: '',
    categoriasSeleccionadas: [], // 🆕 NUEVO
    categoriaPrincipal: null, // 🆕 NUEVO
    descripcion: '',
    precio_minimo: '',
    precio_recomendado: '',
    estado: 'activo'
...
// 🔧 ACTUALIZADO: Guardar servicio con múltiples categorías
...
// 🔧 ACTUALIZADO: Validación de formulario con múltiples categorías
validarFormulario() {
  const errores = [];
  ...
  // 🆕 NUEVO: Validar categorías múltiples
...
// 🔧 ACTUALIZADO: Llenar formulario con múltiples categorías
...
/* 🆕 NUEVOS ESTILOS: Filtro de múltiples categorías */
.filtro-categorias {
display: flex;
flex-direction: column;
gap: 0.5rem;
...
.stat-card.multiples { border-left: 4px solid #9b59b6; } /* 🆕 NUEVO */
...
margin-bottom: 1rem;
min-width: 1100px; /* 🔧 ACTUALIZADO: Más ancho para categorías */
}
...
/* 🆕 NUEVOS ESTILOS: Múltiples categorías en tabla */
...
/* 🆕 NUEVOS ESTILOS: Categorías en tarjetas */
...
background: white;
border-radius: 12px;
max-width: 900px; /* 🔧 ACTUALIZADO: Más ancho para categorías */
width: 100%;
max-height: 90vh;
overflow-y: auto;
...
.detalle-item.categorias-completas { /* 🆕 NUEVO */
flex-direction: column;
align-items: flex-start;
gap: 0.5rem;
}
...
/* 🆕 NUEVOS ESTILOS: Categorías en modal detalle */
.categorias-detalle {
display: flex;
flex-direction: column;
gap: 0.75rem;
...
/* 🆕 NUEVOS ESTILOS: Formulario de múltiples categorías */
...
/* 🆕 NUEVO: Badge para total de categorías */
...
/* 🆕 NUEVOS: Responsive para categorías */
.categorias-container {
 max-width: 200px;
}
...
/* 🆕 NUEVOS: Responsive extremo para categorías */
.categorias-container {
 max-width: 150px;
}
